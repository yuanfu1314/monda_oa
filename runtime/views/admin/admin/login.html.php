...
<?php echo $this->importResource('js', "admin/js/theme.js")?>
<?php echo $this->importResource('js', "admin/js/amazeui.min.js")?>
<?php echo $this->importResource('js', "admin/js/app.js")?>
<?php echo $this->importResource('js', "common/js/jdialog/JDialog.min.js")?>
